...
for eyr in windows_end:
    ...
    analytic_sample = analytic_sample.loc[analytic_sample['weekend']==True]
    mod_res,model_llf,model_df_resid = estimate.fit_model_mi(analytic_sample,['year','state','hour'],2,bsreps,mireps)
...
res_fmt_df.to_excel(results_folder + '\\table2_no_weekend.xlsx') # Note: should format as text after opening Excel file
